...
const RootComponent = (props) => {
  ...
  const addProductToCart = (newProduct) => {
    ...
    let newItems = [];
    if (newProduct.title === "Product 1") {
      newItems = [
        {
          id: "p1",
          title: "Product 1",
          price: cart.products[0].price + 1999,
          qty: cart.products[0].qty + 1,
        },
        {
          id: "p2",
          title: "Product 2",
          price: cart.products[1].price,
          qty: cart.products[1].qty,
        },
      ];
    } else {
      newItems = [
        ...
        },
        {
          id: "p2",
          title: "Product 2",
          price: cart.products[1].price + 999,
          qty: cart.products[1].qty + 1,
        },
      ];
    }
    const newTotalPrice = newItems.reduce((acc, item) => acc + item.price, 0);
    setCart({ ...cart, products: newItems, totalPrice: newTotalPrice });
  };
  ...
  const removeProductFromCart = (removeProduct) => {
    ...
    let newItems = [...cart.products];
    if (removeProduct.title === "Product 1") {
      if (cart.products[0].qty > 0) {
        newItems = [
          {
            id: "p1",
            title: "Product 1",
