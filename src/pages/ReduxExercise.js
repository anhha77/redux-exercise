...
const ProductOne = (props) => {
  ...
  const product = {
    id: useSelector((state) => state.product[0].id),
    title: useSelector((state) => state.product[0].title),
    price: useSelector((state) => state.product[0].price),
  };
  ...
  const removeProductOneFromCart = () => {
        ...
        <Grid item xs={8}>
          <div style={{ display: "flex", justifyContent: "space-around" }}>
            ...
            <Button
              variant="error"
              sx={{ width: "5rem" }}
              onClick={removeProductOneFromCart}
            >
              Remove
            </Button>
          </div>
...
const ProductTwo = (props) => {
  ...
  // You should see the price is updated
  const product = {
    id: useSelector((state) => state.product[1].id),
    title: useSelector((state) => state.product[1].title),
    price: useSelector((state) => state.product[1].price),
  };
  ...
  const addProductTwoToCart = () => {
    dispatch(addToCart(product));
  };

  const removeProductTwoFromCart = () => {
    dispatch(removeCart(product));
  };
        ...
        <Grid item xs={8}>
          <div style={{ display: "flex", justifyContent: "space-around" }}>
            ...
            <Button
              variant="error"
              sx={{ width: "5rem" }}
              onClick={removeProductTwoFromCart}
            >
              Remove
            </Button>
          </div>
...
const CartProductOne = (props) => {
  ...
  const product = {
    price: useSelector((state) => state.cart.products[0].price),
    qty: useSelector((state) => state.cart.products[0].qty),
  };
...
const CartProductTwo = (props) => {
  ...
  // Change the price of products in `service/cart/slice.js` to see the effect
  const product = {
    price: useSelector((state) => state.cart.products[1].price),
    qty: useSelector((state) => state.cart.products[1].qty),
  };
